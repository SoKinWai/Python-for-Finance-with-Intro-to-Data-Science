...
def main():
      ...
      logging.info('Test the doWaterfall function for Pro Rata mode')
      ...
      tranches=StructuredSecurities(loan_pool.Total_principal(),'Pro Rata')
      ...
      file_path_b = 'C:\\Users\\sujhu\\OneDrive\\桌面\\Online Courses\\Python for Finance with Intro to Data Science\\Assignments\\Level 7\\csv_file\\Liabilities_Pro_Rata.csv'
      ...
      file_path_c = 'C:\\Users\\sujhu\\OneDrive\\桌面\\Online Courses\\Python for Finance with Intro to Data Science\\Assignments\\Level 7\\csv_file\\Assets_Pro_Rata.csv'
