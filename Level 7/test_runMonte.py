...
def main():
      ...
      logging.info('Test the runMonte function')
      ...
      tranches_a=StructuredSecurities(loan_pool.Total_principal(),'Sequential')


      #Add two standard tranches (class A and class B in terms of subordination)
      tranches_a.addTranche(0.8, 0.05, 'A')
      tranches_a.addTranche(0.2, 0.08, 'B')
      ...
      logging.info('\n')
      logging.info(f'2000 simulations(tranche A and tranche B): {runMonte(loan_pool, tranches_a, 0.005,2000)}')
      ...
      logging.info('The format will be (DIRR, Rating, WAL, and rate of each tranche) for each tranche:')
      logging.info('\n')
      logging.info(f'2000 simulations(tranche A and tranche B): {runMonte(loan_pool, tranches_b, 0.005, 2000)}')
