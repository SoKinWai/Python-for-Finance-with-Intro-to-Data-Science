...
def main():
      ...
      logging.info('Test the simulaterWaterfall function')
      ...
      #average dirr, average AL, average irr
      logging.info('\n')
      logging.info('This is Sequential mode:')
      logging.info('The format will be (Average dirr, average AL, average irr) for each tranche:')

      logging.info('\n')
      logging.info(f'10 simulations(tranche A and tranche B): {simulateWaterfall(loan_pool, tranches, 10)}')

      logging.info('\n')


      logging.info(f'20 simulations(tranche A and tranche B): {simulateWaterfall(loan_pool, tranches, 20)}')

      logging.info('\n')


      logging.info(f'2000 simulations(tranche A and tranche B):{simulateWaterfall(loan_pool, tranches, 2000)}')
      ...
      logging.info('\n')
      logging.info(f'10 simulations(tranche A and tranche B): {simulateWaterfall(loan_pool, tranches_b, 10)}')

      logging.info('\n')

      logging.info(f'20 simulations(tranche A and tranche B): {simulateWaterfall(loan_pool, tranches_b, 20)}')

      logging.info('\n')

      logging.info(f'2000 simulations(tranche A and tranche B):{simulateWaterfall(loan_pool, tranches_b, 2000)}')
