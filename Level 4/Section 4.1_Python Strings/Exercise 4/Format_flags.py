...
def main():
    ...
    try:
        ...
        if age_a > 0 and name_a != '' and residency_a != '':
            print('%s is %i years old and lives in %s.'%(name_a,age_a,residency_a))
        else:
    ...
    try:
        ...
        if age_b > 0 and name_b != '' and residency_b != '':
            print('%s is %.1f years old and lives in %s.'%(name_b,age_b,residency_b))
        else:
            raise ValueError('Age has to be greater than 0. Name and residency can not be empty.')
    ...
    try:
        ...
        if age_c > 0 and name_c != '' and residency_c != '':
            print('%s is %.1f years old and lives in %s.'%(name_c,age_c,residency_c.upper()))
        else:
            raise ValueError('Age has to be greater than 0. Name and residency can not be empty.')
